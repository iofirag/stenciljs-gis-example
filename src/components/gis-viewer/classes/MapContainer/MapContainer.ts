...
import { MAX_NORTH_EAST, MAX_SOUTH_WEST, DEFAULT_MAP_SETTINGS, DEFAULT_OSM_TILE, FILE_TYPES } from "../statics";
import { Coordinate, MapSettings, GisViewerProps, TileLayerDefinition, ShapeDefinition } from "../../../../models/apiModels";
