...
import * as canvgbrowser from 'html2canvas';

const canvgbrowser: any = require('canvg-browser');
const html2canvas: any = require('html2canvas');
...
export class GisViewer {
    ...
    exportMapImageCh(): Promise<any> {
        ...
        if (canvasElm && linesLayer) {
            canvgbrowser(canvasElm, linesLayer.outerHTML);
        }
        ...
        const canvas: any = html2canvas(document.getElementById("map"), { useCORS: true, svgRendering: true });
