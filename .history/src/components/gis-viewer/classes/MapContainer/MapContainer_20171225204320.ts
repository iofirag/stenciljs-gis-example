import { MAX_NORTH_EAST, MAX_SOUTH_WEST, DEFAULT_MAP_SETTINGS } from "../statics";
import { Coordinate, MapSettings } from "../../../../models/apiModels";
...
export default class MapContainer {
    ...
    public init() {
        ...
        this.context = {
            map,
            props: null, // this.getDefaultOptions(),// this.parentContext.props,
            ...
            zoomToExtend: nullthis.forceZoomToExtend.bind(this),
