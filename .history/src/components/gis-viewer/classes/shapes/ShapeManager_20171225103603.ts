...
export interface ShapeManagerInterface {
	...
	// data layer
	addShapeToLayer(shapeDef: ShapeDefinition, container: L.LayerGroup, eventHandlers?: any): L.Layer | L.FeatureGroup;
...
export abstract class ShapeManagerBase implements ShapeManagerInterface {
	...
	toggleSelectShape(context: GisPluginContext, leafletObject: L.FeatureGroup | L.Layer): void {
