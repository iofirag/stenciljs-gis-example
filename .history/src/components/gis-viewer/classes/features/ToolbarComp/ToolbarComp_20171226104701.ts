...
import { ToolbarPlugins, MapPlugins, FILE_TYPES, LayersTypeLabel, SELECT_LAYER, UNSELECT_LAYER, FILE_TYPES_ARRAY, CoordinateType } from '../../statics';
import Utils from '../../utils';
import { DropDownItemType, ClusterHeat } from '../../../../../models/apiModels';
...
// import { ShapeLayerContainer } from "../../../../../models/shapeLayerContainer";
// import { ClusterHeat, DropDownItemType } from "../../../../../models/apiModels";
...
export default class ToolbarComp {
  ...
  */
  ...
  init() {
    ...
    const a: any = MouseCoordintatePlugin.changeMouseCoordinates;
