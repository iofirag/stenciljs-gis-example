...
import { ToolbarPlugins, MapPlugins, FILE_TYPES, LayersTypeLabel, SELECT_LAYER, UNSELECT_LAYER, FILE_TYPES_ARRAY, CoordinateType, FeaturesNames, CustomControlName } from '../../statics';
