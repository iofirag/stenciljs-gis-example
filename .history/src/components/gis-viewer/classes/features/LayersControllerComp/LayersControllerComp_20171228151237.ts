...
import { LayerNames, FILE_TYPES, ImportFileFormats } from "../../statics";
...
import { ClusterHeat, ShapeLayerDefinition } from "../../../../../models/apiModels";
import { LayersCreatorComp } from "./LayersCreatorComp";
...
//     // this.onOverlayChanged_updateSelections = this.onOverlayChanged_updateSelections.bind(this);
    ...
    (Element.prototype as any).appendHtmlWithContext = function (dom: string) {
      this.innerHTML = dom;
      ...
      elements.forEach(function (element: any) {
        element.getAttribute("attachEvent").split(";").forEach(function (event: any) {
          ...
          if (eventName && eventHandler) {
            element.addEventListener(eventName, this.[eventHandler].bind(context));
          }
        });
      });
    };
...
//   public geoJsonToShapeDef(geoJson: GeoJSON): ShapeDefinition {
