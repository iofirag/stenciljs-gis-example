    ...
    render() {
        ...
        return (
            <div class="dev-components">
                ...
                <div class="body">
                    <div class="sideMenu">
                        <input type="button" title="Export draw" onClick={(event: UIEvent) => this.handleClick(event)}>Export Image</button>
                        <button title="Export draw" onClick={() => { }/*this.testExportDraw*/}/>
