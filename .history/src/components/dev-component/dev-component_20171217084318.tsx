    ...
    render() {
        ...
        return (
            <div class="dev-components">
                ...
                <div class="body">
                    <div class="sideMenu">
                        <input type="button" value="Export draw" onClick={(event: UIEvent) => this.handleClick(event)} />
                        <input type="button" value="test" onClick={(event: UIEvent) => this.handleClick(event)}/>
                        <button value="Export draw" onClick={() => { }/*this.testExportDraw*/}/>
