...
import { EventEmitterData, EventListenerCallback } from '@stencil/core/util/interfaces';
...
export class DevComponent {
    ...
    @Listen('moveEnd')
    onMoveEnd(event: EventEmitterData) {
    ...
    render() {
        return (
            <div class="dev-components">
                ...
                <div class="body">
                    <div class="sideMenu">
                        <input type="button" value="Create Marker" onClick={e => this.testCreateMaerker(e)} />
