...
// import { TileLayerDefinition, MapSettings, ShapeData, MapBounds, ShapeDefinition, GisViewerProps} from '../../../../api-generated/wrapper/api-src';
...
import { TileLayerDefinition, MapSettings, ShapeData, MapBounds, ShapeDefinition, GisViewerProps } from '../../../models/apiModels';
...
export default class MapContainer {
    ...
    constructor(private props: GisViewerProps) {
    ...
    public update(nextProps: GisViewerProps, oldProps: GisViewerProps) {
        ...
        // const selectedObjectsRefList: LPlus.Layer = this.context.selectedLeafletObjects;
    ...
    public init() {
        const map: LPlus.Map = this.createMap();
        ...
        this.context = {
            ...
            zoomToExtend: this.forceZoomToExtend.bind(this),
    ...
    public createMap(): LPlus.Map {
        ...
        return new LPlus.Map('map', extendedOptions);  // Create Map
    }
    ...
    public getBounds(): MapBounds {
        const bounds: LPlus.LatLngBounds = this.context.map.getBounds() as LPlus.LatLngBounds;
    ...
    public selectShapeById(shapeDataArr: ShapeData[]): void {
        const boundsDetectorLayer: LPlus.FeatureGroup = new LPlus.FeatureGroup([]);
        ...
        const selectedShapesDefinitionByIdList: ShapeDefinition[] = <ShapeDefinition[]>selectedLayersById
            .map((layer: LPlus.Layer | LPlus.FeatureGroup) => layer.shapeDef);
        // Execute callback
        this.context.props.onSelectionDone(selectedShapesDefinitionByIdList);
    }

    public getSelectedShapes(): ShapeDefinition[] {
        const selectedObjects: LPlus.Layer[] = Utils.getSelectedObjects(this.context.selectedLeafletObjects);
    ...
    // }
    private fitBounds(bounds: L.LatLngBoundsExpression, options?: FitBoundsOptions): void {
        this.nextBoundsChangeIsProgrammatic = true;
