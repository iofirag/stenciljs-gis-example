import { MarkerShape, ShapeObject, ShapeType, MarkerShapeOptions, ShapeDefinition } from '../../../../../api-generated/wrapper/api-src';
...
export class MarkerShapeManager extends ShapeManagerBase {
	...
	addShapeToLayer(shapeDef: ShapeDefinition, container: LPlus.LayerGroup, eventHandlers: ShapeEventHandlers): LPlus.Layer {
		if (shapeDef.shapeObject) {
			...
			const leafletObject: LPlus.Layer = new LPlus.Marker([lat, lng], markerShapeOptions);
	...
	updateIsSelectedView(leafletObject: LPlus.Marker): void {
