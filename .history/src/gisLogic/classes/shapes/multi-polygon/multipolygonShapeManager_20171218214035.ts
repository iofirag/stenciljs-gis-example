import { ShapeDefinition, PolygonShape, ShapeType, ShapeObject, Coordinate, MultiPolygonShape } from "../../../../models/apiModels";
...
export class MultiPolygonShapeManager extends ShapeManagerBase {
  ...
  addShapeToLayer(shapeDef: ShapeDefinition, container: LPlus.LayerGroup, eventHandlers: ShapeEventHandlers
  ): LPlus.FeatureGroup {
  ...
  public isLayerOfThisShapeType(leafletLayer: LPlus.FeatureGroup): boolean {
