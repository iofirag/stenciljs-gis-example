// import {  ShapeDefinition, CircleShape, CircleShapeOptions, ShapeType, ShapeObject, ShapeObjectOptions, Coordinate } from '../../../../../api-generated/wrapper/api-src';
import { ShapeEventHandlers, ShapeManagerBase } from "../ShapeManager";
import Utils from "../../utils";
import * as _ from 'lodash';
import { ShapeObject } from "../../../../models/apiModels";
...
export class CircleShapeManager extends ShapeManagerBase {
	...
	addShapeToLayer(shapeDef: ShapeDefinition, container: LPlus.LayerGroup, eventHandlers: ShapeEventHandlers): LPlus.Layer {
		if (shapeDef.shapeObject) {
			...
			const ClusterableCircle = LPlus.Circle.extend({
				getBounds: function () {
					return this.getLatLng().toBounds(this._mRadius * 2);
				}
			});

			const leafletObject: LPlus.Layer = <any> new ClusterableCircle(circleShape.coordinate, circleShapeOptionsExtended);
	...
	public isLayerOfThisShapeType(leafletLayer: LPlus.Circle): boolean {
